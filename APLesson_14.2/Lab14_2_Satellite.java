...
public class Lab14_2_Satellite
{
	public static void main(String[]args)
	{
		ArrayList<Lab14_2_Location> locate = new ArrayList<>();
		double[] home = {0,0};
		double [] honLoc = {5,6};
		locate.add(new Lab14_2_Honda(honLoc));
		locate.add(new Lab14_2_Toyota("8, 9"));
		locate.add(new Lab14_2_GMC(3,8));
		
		 String printout = "\n" +
               "==========================" + "\nStarting locations...";


       for (Lab14_2_Location l : locate)
       {
